...
export const adminFormSubmitButton =
  "bg-blue-500 w-24 h-8 rounded-none text-white hover:scale-105 hover:bg-blue-700 transition-all duration-200 ";
...
export const adminLabel =
  "font-bold text-lg bg-black shadow-xl text-white px-2 py-1 rounded-none";
export const adminInput = "border-2 px-2 py-1 text-sm rounded-none";
