  ...
  return (
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        ...
        <div className=" mr-10 bg-grey flex flex-col rounded-none overflow-y-scroll h-[27rem] ">
          <form className={classes.adminForm0} onSubmit={handleSubmit}>
            <div className={classes.adminForm1}>
              <div className={classes.adminForm2l}>
                ...
                {/* new */}
                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Roll No :</h1>
                  <input
                    placeholder={user.result?.rollno}
                    className={classes.adminInput}
                    type="text"
                    value={value.rollno}
                    onChange={(e) =>
                ...
                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Category :</h1>
                  <input
                    placeholder={user.result?.category}
                    className={classes.adminInput}
                    type="text"
                ...
                <div className={classes.adminForm3}>
                  <h1 className={classes.adminLabel}>Address :</h1>
                  <input
                ...
                <div className={classes.adminForm2r}>
                  ...
                  <div className={classes.adminForm3}>
                    ...
                    <input
                      placeholder={user.result?.semester}
                      className={classes.adminInput}
                      type="text"
                  ...
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>Allotment Letter:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, allotment: base64 })
                      }
                    />
                  </div>
                  {/* 6 */}
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>10 Result:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, xresult: base64 })
                      }
                    />
                  </div>
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>12 Result:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, xiiresult: base64 })
                      }
                    />
                  </div>
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>TC/Migration:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, tcmigration: base64 })
                      }
                    />
                  </div>
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>Caste Certificate:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, castecertificate: base64 })
                      }
                    />
                  </div>
                  <div className={classes.adminForm3}>
                    <h1 className={classes.adminLabel}>Income Certificate:</h1>
                    <FileBase
                      type="file"
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, incomecertificate: base64 })
                      }
                    />
                  </div>
                  <div className={classes.adminForm3}>
                    ...
                    <FileBase
                      ...
                      multiple={false}
                      onDone={({ base64 }) =>
                        setValue({ ...value, domicilecertificate: base64 })
                      }
                    />
                  </div>
                </div>
